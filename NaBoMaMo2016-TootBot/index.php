...
$rare_statuses=["ᴛᴏᴏᴛ","ᵗᵒᵒᵗ","ₜₒₒₜ","﻿ｔｏｏｔ","﻿ＴＯＯＴ","𝓣𝓞𝓞𝓣","𝓽𝓸𝓸𝓽","𝘁𝗼𝗼𝘁","𝗧𝗢𝗢𝗧","toot™"];
$chosen_statuses=(rand(0,10) < 1 ? $rare_statuses : $statuses);
$MY_STATUS = $chosen_statuses[array_rand($chosen_statuses)];
